...
from provider import GenerateAnswer, GenerateQuiz, chat_history
...
# ── Sentence transformers offline flag ─────────────────
...
class ACEUI(ctk.CTk):
    def __init__(self):
        ...
        display_path = (
            check_if_path_exists() if check_if_path_exists() else "No Path Indexed"
        )
